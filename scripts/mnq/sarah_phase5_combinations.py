"""Run controlled Phase 5 combinations around Sarah's first-touch core.
...
Run from the repository root:
    ...
    .venv/bin/python scripts/mnq/sarah_phase5_combinations.py
"""
...
DEFAULT_PHASE4 = ROOT / "reports" / "sarah_phase4"
DEFAULT_OUTPUT = ROOT / "reports" / "sarah_phase5"
    ...
    for variant, group in metrics_by_split.groupby("variant", sort=False):
        ...
        rows.append({
            ...
            "candidate_type": "reference" if variant in {
                "Sarah baseline", "First physical touch core"
...
def write_report(
    ...
    <title>Sarah Phase 5 combinations</title><style>{STYLE}</style></head><body><main class='wrap'>
    <div class='eyebrow'>MNQ · Sarah strategy lab</div><h1>Phase 5 controlled combinations</h1>
    ...
    <p class='note'><a href='../sarah_dashboard/index.html'>Main dashboard</a> · <a href='../sarah_phase4/index.html'>Phase 4 report</a></p>
