...
DEFAULT_REFERENCE = ROOT / "reports" / "sarah_phase6" / "pine_parity_reference_2026.csv"
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=ROOT / "reports" / "sarah_phase6" / "parity_result.json")
