...
Run from the repository root:
    ...
    .venv/bin/python scripts/mnq/sarah_phase6_release.py
"""
...
from sarah_html_report import SCRIPT as CHART_SCRIPT
from sarah_html_report import comparison_frames, metrics, svg_line_chart
from sarah_phase5_combinations import STYLE as PREVIOUS_REPORT_STYLE


ROOT = Path(__file__).resolve().parents[2]
PHASE5 = ROOT / "reports" / "sarah_phase5"
SOURCE_LEDGER = PHASE5 / "04_first_touch_open_room" / "trades.parquet"
BASELINE_LEDGER = ROOT / "reports" / "sarah_baseline" / "trades.parquet"
PINE = ROOT / "sarah.pine"
PINE_STRATEGY = ROOT / "sarah_phase6_strategy.pine"
OUTPUT = ROOT / "reports" / "sarah_phase6"
TZ = "America/Chicago"
TICK_SIZE = 0.25
POINT_VALUE = 2.0
...
def main() -> None:
    ...
    specification = {
        "name": "Sarah Phase 6 locked candidate",
        ...
        "zone_detection": "Sarah two-candle reversal with prior/impulse body ratio <= 0.50",
        ...
        "sessions": "Sarah session rules preserved, including the existing no-trade window",
    ...
    series = {"Sarah baseline": baseline, "Phase 6 locked candidate": candidate}
    ...
    page = f"""<!doctype html><html><head><meta charset='utf-8'><meta name='viewport' content='width=device-width,initial-scale=1'><title>Sarah Phase 6</title><style>{STYLE}</style></head><body><main class='wrap'>
    <div class='eyebrow'>MNQ · Sarah strategy lab</div><h1>Phase 6 · implementation & validation</h1>
    ...
    <p class='note'><a href='../sarah_dashboard/index.html'>Main dashboard</a> · <a href='../sarah_phase5/index.html'>Phase 5 report</a></p>
