...
import sarah_phase2_dataset as phase2
import sarah_baseline_backtest as baseline_engine
import sarah_phase4_backtest as phase4
...
from sarah_phase5_combinations import STYLE
...
TRADES = ROOT / "reports" / "sarah_phase6" / "locked_candidate_trades.parquet"
ZONES = ROOT / "reports" / "sarah_phase2" / "zones_enriched.parquet"
RETESTS = ROOT / "reports" / "sarah_phase2" / "retests_enriched.parquet"
OUTPUT = ROOT / "reports" / "sarah_phase7_rvol"
TZ = "America/Chicago"
LOOKBACK = 20
MIN_PERIODS = 10
...
def build_report(frame: pd.DataFrame, buckets: pd.DataFrame, thresholds: pd.DataFrame,
    ...
    page = f"""<!doctype html><html><head><meta charset='utf-8'><meta name='viewport' content='width=device-width,initial-scale=1'><title>Sarah Phase 7 · RVOL</title><style>{STYLE}</style></head><body><main class='wrap'>
    <div class='eyebrow'>MNQ · Sarah strategy lab</div><h1>Phase 7 · relative-volume confluence</h1>
    ...
    <p class='note'><a href='../sarah_phase6/index.html'>Phase 6 report</a> · <a href='../sarah_dashboard/index.html'>Main dashboard</a></p>
